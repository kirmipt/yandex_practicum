**Выполнив 1 проект сам, я решил сэкономить время и просто изучать чужие проекты, задаваясь на каждом шаге вопросом "что сделал бы я" и выписывая моменты, которые мне были не очевидны.**
<br>
