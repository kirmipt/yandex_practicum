# Выполнив 1 проект сам, я решил сэкономить время и просто изучать чужие проекты, задаваясь вопросом "что сделал бы я на каждом шаге" и выписывая методики которые ранее мне не были известны.
