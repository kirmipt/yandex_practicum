# Выполнив 1 проект я решил просто изучать проекты, задаваться вопросом что я бы сделал на каждом шаге и выписывать методики которые ранее мне не были известны.
