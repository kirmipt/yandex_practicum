**Выполнив 1 проект сам, я решил сэкономить время и просто изучать чужие проекты, задаваясь на каждом шаге вопросом "что сделал бы я" и выписывая новые методики/важные алгоритмы действий. Возможно вернусь к прорешиванию кодом**
<br>
...
<br>1-Предобработка данных, 2-исследовательский анализ, 4.1-сбор веб-данных, 4.2.5-яндекс.метрика, 6.1.3-пайплайны
