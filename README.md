# Выполнив 1 проект сам я решил сэкономить время и просто изучать чужие проекты, задаваться вопросом что я бы сделал на каждом шаге и выписывать методики которые ранее мне не были известны.
