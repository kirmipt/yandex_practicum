...
<br>
<br>**1 проект я выполнил сам, следующие 2 - решил просто изучить чужие.** Мне нужны знания о новых методиках, понимать стандарт выполнения и оформления проекта, а не очередной проект в резюме. **Проекты с sql нужно прорешать самому.**
<br>
