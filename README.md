# Выполнив 1 проект я решил сэкономить время и просто изучать проекты, задаваться вопросом что я бы сделал на каждом шаге и выписывать методики которые ранее мне не были известны.
