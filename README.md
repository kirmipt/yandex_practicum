...
<br>
<br>**1 проект я выполнил сам, следующие 2 - решил просто изучить чужие**, хотя я задавался вопросами что сделал бы я и смотрел делает ли человек так. 
<br> Мне нужны знания о новых методиках, понимать стандарт выполнения и оформления проекта, а не очередной проект в резюме. **Проекты с sql нужно прорешать самому.**
<br>
