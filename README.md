**Выполнив 1 проект сам, я решил сэкономить время и просто изучать чужие проекты, задаваясь на каждом шаге вопросом "что сделал бы я" и выписывая методики, которые ранее мне не были известны.**
<br>[Материалы курса](https://drive.google.com/drive/folders/1V_pzOS9TQMkzPigRdAD3b2B63XCpDzAY?usp=sharing) - планирую сначала изучить темы которые не затронуты в karpov.courses:
1-Предобработка данных, 2-исследовательский анализ, 4.1-сбор веб-данных, 4.2.5-яндекс.метрика, 6.1.3-пайплайны
