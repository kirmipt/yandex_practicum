...
# Мои конспекты (прогресс изучения теории - 1/9)
...
<br>
<br>**Изучены 2.5/14 проектов**
<br>
<br>**1 проект я выполнил сам, следующие 2 - решил просто изучить чужие**, хотя я задавался вопросами "что сделал бы я" и иногда сам смотрел срезы данных. 
<br> Мне нужны знания о новых методиках, знать алгоритм действий, увидеть, какой есть стандарт оформления проекта, а не очередной проект в резюме. **Проекты с sql нужно прорешать самому.**
<br>
